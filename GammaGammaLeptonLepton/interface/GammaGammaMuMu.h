...
class GammaGammaMuMu : public edm::EDAnalyzer {
 ...
 //     edm::EDGetTokenT< std::vector<TotemFEDInfo> > tokenFEDInfo_;
      ...
      Double_t GenPair_phi, GenPair_eta, GenPair_Y;
...
// PPS 2017
      ...
      Int_t nVertices,nArmsTimingRecHits, nArmsTimingTracks, nTracksTiming, nRecHitsTiming;
 

      Int_t nTracksStrips, nArmsStrips;
      Int_t ArmStrips[100],  StationStrips[100],  RPStrips[100], StripsMysteryFlag[100];
;
      Double_t StripTrackX[100], StripTrackY[100],StripTrackZ[100], StripTrackTx[100], StripTrackTy[100];

      Int_t nPixelRecHits, nArmsPixRecHits;
      Double_t PixRecHitX[1000], PixRecHitY[1000], PixRecHitZ[1000];
      Int_t PixRecHitArm[1000], PixRecHitPlane[1000];

      Int_t nPixelTracks, nArmsPixelTracks, nPixelTracksArm1, nPixelTracksArm2, nLayersArm1PixRecHits, nLayersArm2PixRecHits;
      ...
      // Extra tracks
      Int_t Pair_extratracks0pt5mm[MAX_PAIRS];
      ...
      Double_t KalmanVertexCand_chi2;
      Int_t KalmanVertexCand_ndof;
